...
api_router.include_router(users_router, prefix=settings.API_V1_STR + "/users", tags=["users"])
api_router.include_router(rooms_router, prefix=settings.API_V1_STR + "/rooms", tags=["rooms"])
